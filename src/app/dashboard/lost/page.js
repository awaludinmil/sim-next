        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card p-6 bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Perhatian!</h3>
            ...
            <section className="card p-6">
              <h2 className="font-bold text-lg text-gray-900 mb-4">Alasan Kehilangan</h2>
            ...
            {/* Report Form Preview */}
            <section className="card p-6">
              <h2 className="font-bold text-lg text-gray-900 mb-4">Formulir Laporan</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-amber-400 transition-colors cursor-pointer">
                    ...
                    <p className="text-sm text-gray-600">
                      <span className="font-medium text-amber-600">Klik untuk upload</span> atau drag & drop
                    </p>
          ...
          <div className="space-y-6">
            ...
            <div className="card p-6">
              <h3 className="font-bold text-lg text-gray-900 mb-4">Proses Pelaporan</h3>
              <div className="space-y-4">
                {steps.map((step, index) => (
                  <div key={step.number} className="flex items-start gap-3">
                    <div className="w-8 h-8 bg-amber-100 rounded-full flex items-center justify-center text-amber-600 font-bold text-sm flex-shrink-0">
                      {step.number}
                    </div>
                    <div>
            ...
            <div className="card p-6 sticky top-24">
              <h3 className="font-bold text-lg text-gray-900 mb-4">Biaya Penggantian</h3>
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-500">Biaya SIM Baru</span>
                  <span className="font-medium text-gray-900">Sesuai jenis</span>
                </div>
                <hr className="border-gray-200" />
                <div className="flex items-center justify-between">
                  <span className="font-medium text-gray-700">Estimasi</span>
                  <span className="font-bold text-lg text-amber-600">Rp 130.000</span>
                </div>
              </div>
              <button 
            ...
            <div className="card p-6 bg-gradient-to-br from-amber-50 to-orange-50 border-amber-100">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Hotline Darurat</h4>
                  <p className="text-sm text-gray-600 mb-2">Lapor cepat ke call center</p>
                  <a href="tel:14020" className="text-lg font-bold text-amber-600 hover:underline">14020</a>
                </div>
              </div>
            </div>
          </div>
